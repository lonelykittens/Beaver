...
public class ListViewAdapter extends BaseAdapter {
    ...
    private ArrayList<AlarmMsg> listViewItemList = new ArrayList<AlarmMsg>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AlarmMsg listViewItem = listViewItemList.get(position);
    ...
    public void addItem(String title, String content, String date, int rownum) {
        AlarmMsg item = new AlarmMsg();
        item.setDate(date);
        item.setTitle(title);
